...
//  AIChatApp
//
//  Created by Weijia Huang on 9/26/24.
//
...
class ChatViewController: MessagesViewController {
    ...
    private var selfSender: Sender? {
        ...
        print("Safe email for selfSender: \(safeEmail)")  // Ensure this is in safe email format
        ...
        DatabaseManager.shared.getAllMessagesForConversation(with: id, completion: { [weak self] result in
                ...
                case .success(let messages):
                    ...
                    for message in messages {
                        print("Fetched message sender ID: \(message.sender.senderId)")  // Ensure this is in safe email format
                    }
...
extension ChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    func messageForItem(at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> MessageType {
        ...
        print("Message sender ID: \(message.sender.senderId)")
        return message
    }
